...
/**
 * Test case for class Tx_Countrymanager_Controller_CountryLanguageController.
 *
 * @version $Id$
 ...
 */
class Tx_Countrymanager_Controller_CountryLanguageControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
