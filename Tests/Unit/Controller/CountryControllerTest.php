...
/**
 * Test case for class Tx_Countrymanager_Controller_CountryController.
 *
 * @version $Id$
 ...
 */
class Tx_Countrymanager_Controller_CountryControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
