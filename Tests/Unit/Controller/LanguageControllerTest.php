...
/**
 * Test case for class Tx_Countrymanager_Controller_LanguageController.
 *
 * @version $Id$
 ...
 */
class Tx_Countrymanager_Controller_LanguageControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
